    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aadhar', models.FileField(blank=True, null=True, upload_to='employees/aadhar/')),
                ('pan', models.FileField(blank=True, null=True, upload_to='employees/pan/')),
                ('dl', models.FileField(blank=True, null=True, upload_to='employees/dl/')),
                ('appointment', models.FileField(blank=True, null=True, upload_to='employees/appointment/')),
                ('promotion', models.FileField(blank=True, null=True, upload_to='employees/promotion/')),
                ('resume', models.FileField(blank=True, null=True, upload_to='employees/resumes/')),
                ('insurance_number', models.CharField(max_length=100)),
                ('esic_card', models.FileField(blank=True, null=True, upload_to='employees/esic/')),
                ('epf_member', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('insurance_number', models.CharField(max_length=100)),
                ('esic_card', models.FileField(blank=True, null=True, upload_to='employees/esic/')),
                ('epf_member', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], default='no', max_length=3)),
                ('uan', models.CharField(max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_doc', models.FileField(blank=True, null=True, upload_to='employees/bank_documents/')),
