...
const sampleEvents = [
  {
    ...
    employee: "John Doe",
    description:
      "A one-day workshop focused on developing leadership skills for managers and team leads.",
    status: "upcoming",
  },
  {
    id: 2,
    ...
    employee: "Sarah Lee",
    description:
      "Discuss the goals achieved in Q2 and align on plans for Q3 across all departments.",
    status: "completed",
  },
  {
    id: 3,
    ...
    employee: "Emily Chen",
    description:
      "Annual employee performance evaluations and goal setting for next year.",
    status: "upcoming",
  },
  {
    id: 4,
    ...
    description:
      "Conduct exit interview and knowledge transfer from departing employee.",
    status: "cancelled",
  },
];
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {events.map((event) => (
                  ...
                  >
                    ...
                    <div
                      className={`mt-4 text-xs font-semibold uppercase tracking-wide px-3 py-1 rounded-full w-fit ${
